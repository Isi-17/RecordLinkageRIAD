...
output_folder = 'blocking_results'
if not os.path.exists(output_folder):
    os.makedirs(output_folder)

# Save the ID Blocking results
id_blocking_filename = f"blocking_results/id_blocking_output_{today}.csv"
...
for country in countries:
    ...
    if tot_entities < 20000:
        ...
        print(f"Total execution time for this block: {total_time:.2f} seconds. If we are not in a big country, I am done, otherwise I will continue")
...
print(f"What a rally, it took me in total {total_time:.2f} seconds")
