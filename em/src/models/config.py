...
class Config():
    MODELS = {
        ...
        'mbert': LanguageModelConfig(BertForSequenceClassification, BertConfig, 'bert-base-multilingual-cased', BertTokenizer),
        'xlm-roberta': LanguageModelConfig(XLMRobertaForSequenceClassification, XLMRobertaConfig, 'xlm-roberta-base', XLMRobertaTokenizer),
    ...
    DATASETS = {
        'riad_entities': 'ditto_files/riad_entities'
    }
...
def read_arguments_train():
    ...
    parser.add_argument('--dataset_name', default='riad_entities',
    ...
    parser.add_argument('--pos_weight', default=1.0, type=float, help='Weight for positive class in NLLLoss (higher = more recall)')
    parser.add_argument('--decision_threshold', default=0.5, type=float, help='Decision threshold for match classification')
